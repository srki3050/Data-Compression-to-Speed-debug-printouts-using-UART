 ...
 * File  				: uart.c
 * Date	 				: 05/02/2022
 * Brief 				: Definition code to initialize UART as per user requirements, and perform enqueue and dequeue byte-by-byte
 *						  in Interrupt handler
 * References			: Initialization code inspired from Dean ch8, IRQ code majorly inspired from professor's lecture on serial
 ...
 * Not used in this project since we are going only for debug printouts.
 */
